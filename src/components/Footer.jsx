...
const Footer = () => {
  return (
    <div className="w-full flex gap-5 items-start h-screen big-zinc-900 p-20">
      <div className="w-1/2 h-full flex flex-col justify-between font-mono">
        <div className="heading">
          <h1 className="text-[8vw] leading-none uppercase font-semibold -mb-5">
            Eye
          </h1>
          <h1 className="text-[8vw] leading-none uppercase font-semibold -mb-5">
            Opening
      ...
      <div className="w-1/2">
        <h1 className="text-[5vw] leading-none uppercase font-semibold -mb-10">Presention</h1>
